...
class ComputeLossOTA:
    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            #print(type(from_which_layer))
            from_which_layer = torch.cat(from_which_layer, dim=0)
            
            #from_which_layer = from_which_layer.cuda()
            
            #print(type(from_which_layer))
            #print(from_which_layer.device)
            #print(type(all_b))
            ...
            #print(type(fg_mask_inboxes),fg_mask_inboxes.device)   #GPU
            #print(type(from_which_layer),from_which_layer.device) #CPU
            #fg_mask_inboxes = fg_mask_inboxes.cpu()
            #print(type(fg_mask_inboxes),fg_mask_inboxes.device)   #GPU
            #print(type(from_which_layer),from_which_layer.device)
            #print(fg_mask_inboxes)
            #print(from_which_layer.shape)
