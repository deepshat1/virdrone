...
class Model(nn.Module):
    def __init__(self, cfg='yolor-csp-c.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
        ...
        if isinstance(m, Detect):
            ...
            check_anchor_order(m) #检验ancher顺序 对不对
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC,CBAM,GSConv,VoVGSCSP,VoVGSCSPC,GSConv,
                 Conv3BN,MobileNetV3_InvertedResidual,ShuffleNetV2_InvertedResidual]:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default=r'D:\data\yolov7\cfg\training\yolov7_shufflev2_gsconv.yaml', help='model.yaml')
